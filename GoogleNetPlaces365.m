...
% training the GoogleNet (Places365)
...
title('Confusion Matrix Using GoogleNet (Places365)')

% Optional: Save the training curve and the fine-tuned model
% currentfig = findall(groot,'Type','Figure'); savefig(currentfig,'GoogleNet (Places365) Learning Curve.fig')
