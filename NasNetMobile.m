...
title('Confusion Matrix Using NasNetMobile')

% Optional: Save the training curve and the fine-tuned model
% currentfig = findall(groot,'Type','Figure'); savefig(currentfig,'NasNetMobile Learning Curve.fig')
