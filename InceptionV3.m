...
title('Confusion Matrix Using Inception-V3')

% Optional: Save the training curve and the fine-tuned model
% currentfig = findall(groot,'Type','Figure'); savefig(currentfig,'Inception-V3 Learning Curve.fig')
